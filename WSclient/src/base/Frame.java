...
import service_endpoint.ServiceService;
import types.*;
...
public class Frame extends javax.swing.JFrame {
    ...
    static ServiceService serviceService = null;
    ...
    private void initComponents() {
        ...
        lb1.setText("Справочники:");

        btn1.setText("Автозапчасти");
        ...
        lb8.setText("Огородников Дмитрий Алексеевич - Вариант 14");

        btnsum.setText("Подсчитать сумму");
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        ...
        model.setRowCount (0);
        model.setColumnIdentifiers(new Object[]{"id", "Название", "Марка", "Поставщик", "Гарантия", "Акция","Количество","Сумма"});
        try {
            doVivodA(serviceService.getServicePort().getA());
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void btn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn2ActionPerformed
        ...
        try {
            doVivodB(serviceService.getServicePort().getB());
        } catch (Exception ex) {
            ex.printStackTrace();
                JOptionPane.showMessageDialog(this, "Не удалось установить соединение с сервером:" + ex.getMessage() + ".",
                "Ошибка",
    ...
    private void btn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn3ActionPerformed
        ...
        try {
            doVivodP(serviceService.getServicePort().getP());
        } catch (Exception ex) {
            ex.printStackTrace();
                JOptionPane.showMessageDialog(this, "Не удалось установить соединение с сервером:" + ex.getMessage() + ".",
                "Ошибка",
    ...
    private void btn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn4ActionPerformed
        ...
        txt04.setVisible(true);
        try {
            doVivodS(serviceService.getServicePort().getS());
        } catch (Exception ex) {
            ex.printStackTrace();
                JOptionPane.showMessageDialog(this, "Не удалось установить соединение с сервером:" + ex.getMessage() + ".",
                "Ошибка",
    ...
    private void btn5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn5ActionPerformed
        ...
        txt04.setVisible(false);
        try {
            doVivodW(serviceService.getServicePort().getW());
        } catch (Exception ex) {
            ex.printStackTrace();
                JOptionPane.showMessageDialog(this, "Не удалось установить соединение с сервером:" + ex.getMessage() + ".",
                "Ошибка",
    ...
    private void btn6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn6ActionPerformed
        ...
        try {
            txt3.setModel(getColumnB(serviceService.getServicePort().getB()));
            txt4.setModel(getColumnP(serviceService.getServicePort().getP()));
            txt5.setModel(getColumnS(serviceService.getServicePort().getS()));
            txt6.setModel(getColumnW(serviceService.getServicePort().getW()));
        } catch (Exception ex) {
    ...
    private void btn8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn8ActionPerformed
        ...
        add1.setVisible(false);
        Autoparts A = new Autoparts();
        //Autoparts A = new Autoparts(Integer.parseInt(txt1.getText()),txt2.getText(),txt3.getSelectedItem().toString(), txt4.getSelectedItem().toString(),txt5.getSelectedItem().toString(),txt6.getSelectedItem().toString(),(Integer)sp1.getValue(), scb1.getValue());
        A.setId(Integer.parseInt(txt1.getText()));
        A.setName(txt2.getText());
        A.setBrand(txt3.getSelectedItem().toString());
        A.setPromotion(txt4.getSelectedItem().toString());
        A.setSupplie(txt5.getSelectedItem().toString());
        A.setWarranty(txt6.getSelectedItem().toString());
        A.setKol((Integer)sp1.getValue());
        A.setPrice(scb1.getValue());
        doClearTable();
        try {
            doVivodA(serviceService.getServicePort().setA(A));
        } catch (Exception ex) {
            Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
        }
        error1.setText("");
    ...
    private void btn10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn10ActionPerformed
                ...
                switch (sw)
        {
            case 2:
                ...
                B.setName(txt01.getText());
                B.setDescription(txt02.getText());
                doClearTable();
        try {
            doVivodB(serviceService.getServicePort().setB(B));
        } catch (Exception ex) {
            Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
        }
                break;
            case 3:
                ...
                //P = new Promotions(txt01.getText(),txt02.getText(),Integer.parseInt(txt03.getText()),txt04.getText());
                P.setName(txt01.getText());
                P.setData(txt02.getText());
                P.setDuration(Integer.parseInt(txt03.getText()));
                P.setEssence(txt04.getText());
                doClearTable();
        try {
            doVivodP(serviceService.getServicePort().setP(P));
        } catch (Exception ex) {
            Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
        }
                break;
            case 4:
                ...
                //S = new Suppliers(txt01.getText(),txt02.getText(),Long.parseLong(txt03.getText()),Long.parseLong(txt04.getText()));
                S.setName(txt01.getText());
                S.setAddress(txt02.getText());
                S.setTelephone(Long.parseLong(txt03.getText()));
                S.setInn(Long.parseLong(txt04.getText()));
                doClearTable();
        try {
            doVivodS(serviceService.getServicePort().setS(S));
        } catch (Exception ex) {
            Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
        }
                break;
            case 5:
                ...
                //W = new Warranty(txt01.getText(),Integer.parseInt(txt02.getText()));
                W.setType(txt01.getText());
                W.setDuration(Integer.parseInt(txt02.getText()));
                doClearTable();
        try {
            doVivodW(serviceService.getServicePort().setW(W));
        } catch (Exception ex) {
            Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
        }
                break;
    ...
    private void btn7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn7ActionPerformed
        ...
        switch (sw){
            case 1:
                doClearTable();
                try {
                    doVivodA (serviceService.getServicePort().remA(sr));
                } catch (Exception ex) {
                    Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
                }
                break;
            case 2:
                doClearTable();
                try {
                    doVivodB (serviceService.getServicePort().remB(sr));
                } catch (Exception ex) {
                    Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
                }
                break;
            case 3:
                doClearTable();
                try {
                    doVivodP (serviceService.getServicePort().remP(sr));
                } catch (Exception ex) {
                    Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
                }
                break;
            case 4:
                doClearTable();
                try {
                    doVivodS (serviceService.getServicePort().remS(sr));
                } catch (Exception ex) {
                    Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
                }
                break;
            case 5:
                doClearTable();
                try {
                    doVivodW (serviceService.getServicePort().remW(sr));
                } catch (Exception ex) {
                    Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
                }
                break;
    ...
    private void btnsumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsumActionPerformed
        try {
            // TODO add your handling code here:
            txtsum.setText(Integer.toString(serviceService.getServicePort().getSumA()));
        } catch (Exception ex) {
            Logger.getLogger(Frame.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnsumActionPerformed

    private void doVivodA(ListA lstA)
    {
        for (Autoparts autoparts: lstA.getItem())
        {
    ...
    private void doVivodB(ListB lstB)
    {
        for (Brands brands: lstB.getItem())
        {
    ...
    private void doVivodP(ListP lstP)
    {
        for (Promotions promotions: lstP.getItem())
        {
    ...
    private void doVivodS(ListS lstS)
    {
        for (Suppliers suppliers: lstS.getItem())
        {
            Object[] rowData = new Object[4];
    ...
    private void doVivodW(ListW lstW)
    {
        for (Warranty warranty: lstW.getItem())
        {
            Object[] rowData = new Object[2];
    ...
    private DefaultComboBoxModel getColumnB(ListB lstB){
    ...
    private DefaultComboBoxModel getColumnP(ListP lstP){
        DefaultComboBoxModel Cmodel = new DefaultComboBoxModel();
        for (Promotions promotions: lstP.getItem())
        {
    ...
    private DefaultComboBoxModel getColumnS(ListS lstS){
        DefaultComboBoxModel Cmodel = new DefaultComboBoxModel();
        for (Suppliers suppliers: lstS.getItem())
        {
    ...
    private DefaultComboBoxModel getColumnW(ListW lstW){
        DefaultComboBoxModel Cmodel = new DefaultComboBoxModel();
        for (Warranty warranty: lstW.getItem())
        {

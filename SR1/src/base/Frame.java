...
public class Frame extends javax.swing.JFrame {
    ...
    OperationImpl Operations = new OperationImpl();
    ...
    private void btn8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn8ActionPerformed
        ...
        add1.setVisible(false);
        Autoparts A;
        A = new Autoparts(Integer.parseInt(txt1.getText()),txt2.getText(),txt3.getSelectedItem().toString(), txt4.getSelectedItem().toString(),txt5.getSelectedItem().toString(),txt6.getSelectedItem().toString(),(Integer)sp1.getValue(), scb1.getValue());
        doClearTable();
    ...
    private void doVivodA(List<Autoparts> lstA)
    {
    ...
    {
        for (Promotions promotions: lstP)
        {
    ...
    private DefaultComboBoxModel getColumnP(List<Promotions> lstP){
        DefaultComboBoxModel Cmodel = new DefaultComboBoxModel();
        for (Promotions promotions: lstP)
        {
    ...
    private DefaultComboBoxModel getColumnS(List<Suppliers> lstS){
        DefaultComboBoxModel Cmodel = new DefaultComboBoxModel();
        for (Suppliers suppliers: lstS)
        {
    ...
    private DefaultComboBoxModel getColumnW(List<Warranty> lstW){
        DefaultComboBoxModel Cmodel = new DefaultComboBoxModel();
        for (Warranty warranty: lstW)
        {
